...
This method is bundled into `kang-meta-skill`. Do not check for, download, install, or load another discovery skill.
...
- `adapt`: useful mechanisms that require Kang conventions, different tools, or lighter gates
