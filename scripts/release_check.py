#!/usr/bin/env python3
"""Audit local, PR, or published release readiness for a Kang skill."""
...
SPEC = importlib.util.spec_from_file_location("kang_validate_skill", SCRIPT_DIR / "validate_skill.py")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Check Kang skill release readiness.")
